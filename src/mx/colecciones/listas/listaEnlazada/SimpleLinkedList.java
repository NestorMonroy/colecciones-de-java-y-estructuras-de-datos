...
public class SimpleLinkedList {
	...
	public void push(Object obj) {
		...
		//Ahora el nuevo nodo creado es el primero (apunta primero a first y luevo newNode es el nuevo firs)
	...
	public void printContent() {
		Node currentNode = first;
		System.out.println("Mostrar elementos en la lista enlazada");
